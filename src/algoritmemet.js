const dadesProva = {
    ...
    dxConcret: "pneumonia", // String: Diagnòstic concret ("pneumonia", "altre" o null)
    sospitaTEP: false, // Boolean: Si hi ha sospita de TEP
    tepConfirmat: false, // Boolean: Si s'ha confirmat el TEP
    immunocompetent: false, // Boolean: Si el pacient és immunocompetent
    immunosupressors: false, // Boolean: Si el pacient és immunodeprimit
    pcrPositivaInfluenza: false, // Boolean: Si la PCR és positiva per Influenza
    sospitaCMV: false, // Boolean: Si hi ha sospita de CMV
    sospitaPneumocystis: false, // Boolean: Si hi ha sospita de Pneumocystis jirovecii
    necessitaOxigenoterapia: false, // Boolean: Si requereix oxigenoteràpia
    inhibidorBombaProtons: false, // Boolean: Si necessita inhibidor de bomba de protons
    nAcetilcisteina: false, // Boolean: Si necessita N-Acetilcisteïna
    nebulitzacions: false, // Boolean: Si necessita nebulitzacions
    hbpmNecessari: false, // Boolean: Si requereix HBPM
    metilprednisolona: false, // Boolean: Si requereix Metilprednisolona
    losartanNecessari: false, // Boolean: Si requereix Losartan
};
